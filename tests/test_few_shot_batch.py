...
sys.path.insert(0, os.path.join(os.path.dirname(os.path.dirname(__file__)), "Mistral_Batch_Processor", "Mistral-Batch-Prompts-Training-Data"))
...
def test_few_shot_batch():
    ...
    # Load system prompt
    system_prompt_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "Mistral_Batch_Processor", "Mistral-Batch-Prompts-Training-Data", "SOS-Triage-Agent-Sys-Prompt.md")
